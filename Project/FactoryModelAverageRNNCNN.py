...
Command to run the file: python FactoryModelAverageRNNCNN.py 
i. main - runs all of the functions
    ...
    iv. LSTM_CNN - runs the neural network with LSTM-CNN and predicts on the test set.
...
def main():
    ...
    LSTM_CNN(vectorized_data, test_ids, wordindex, len(vocab), combined_embedding, totalpadlength, num_epochs=3, 
...
def LSTM_CNN(vectorized_data, test_ids, wordindex, vocablen, embedding_tensor, totalpadlength, num_epochs=3, 
